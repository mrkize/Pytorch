...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, image_size=224, patch_size=16, in_c=2, embed_dim=768, norm_layer=None):
        """
...
class VisionTransformer(nn.Module):
    def __init__(self, image_size=224, patch_size=16, in_c=3, num_classes=10,
                 embed_dim=804, depth=12, num_heads=12, mlp_ratio=4.0, qkv_bias=True,
        ...
        self.pe = Patch_Embed(dim=embed_dim)
...
def vit_base_patch16_224_in21k(num_classes: int = 21843, has_logits: bool = True):
    ...
    model = VisionTransformer(image_size=224,
                              ...
                              depth=4,
                              num_heads=12,
                              representation_size=804 if has_logits else None,
